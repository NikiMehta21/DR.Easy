...
class ViewStaff extends Component
{
    ...
    componentDidMount()
    {
        const id = this.props.match.params.staffid;
        
        const url = "http://localhost:80/doctor/ViewStaff.php";
        Axios.get(url, {
            params: {
                id: id
            }
    ...
    submitbtn = e =>{
        ...
        formData.append("id",this.props.match.params.staffid);

        const url = "http://localhost:80/doctor/updatestaff.php";
    ...
    render() {
        ...
        return (
          <IonApp>
              <IonHeader>
                  <Sidemen/>
                  <IonToolbar><IonTitle> Staff Account</IonTitle></IonToolbar>
              </IonHeader>
              <IonContent>
                  <div class="card">
                      <IonItem>
